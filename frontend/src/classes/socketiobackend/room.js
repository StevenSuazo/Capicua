...
class Room {
    constructor(numPlayers, heightDimen, roomName, io,) {
    ...
    createGame() {
        ...
        this.board = new BoardObject(this.players, this.heightDimen, this.roomName, this.io)
    ...
    sendGameState() {
        ...
        if (this.board.winningPlayer) {
            winningPlayer = {
                username: this.board.winningPlayer.username,
        ...
        return {
            ...
            players: players,
            currentPlayer: {
                username: this.board.currentPlayer.username,
